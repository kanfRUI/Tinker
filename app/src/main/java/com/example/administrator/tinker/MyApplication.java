...
public class MyApplication extends TinkerApplication {
    public static final String APP_ID = "cd5cab44b8"; // TODO 替换成bugly上注册的appid
    public static final String APP_CHANNEL = "DEBUG"; // TODO 自定义渠道
    private static final String TAG = "OnUILifecycleListener";
    public MyApplication() {
            super(ShareConstants.TINKER_ENABLE_ALL, "com.example.administrator.tinker.SampleApplicationLike",
